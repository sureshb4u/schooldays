var vApp = angular
    .module('atrium-frontend', ['ngAnimate', 'ngCookies', 'ngTouch', 'ngSanitize', 'ngResource', 'ngRoute', 'ngMaterial','pascalprecht.translate', 'lumx', 'treasure-overlay-spinner', 'ngFileUpload','ui.bootstrap','textAngular','ngMdIcons','ui.router','mgcrea.jquery','datePicker','angular-datepicker'])
