// Generated on 2015-06-28 using generator-jhipster 2.16.1
'use strict';
var fs = require('fs');
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        wiredep: {
            app: {
                src: ['src/main/webapp/scripts/index.html'],
                exclude: [
        ...
        useminPrepare: {
            html: ['src/main/webapp/scripts/app/**/*.html'],
            options: {
                dest: '<%= yeoman.dist %>',
                flow: {
                    html: {
